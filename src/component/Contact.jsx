  ...
  return (
    ...
    >
      ...
      <p className="text-sm xl:text-md leading-5 text-center z-40">
        ...
        development. <br />
        Let's create visually engaging and user-friendly websites together!
      </p>
      <div className="z-10 flex justify-center gap-9 my-[5rem]">
        ...
        <a target="_blank" href="https://twitter.com/metalekan">
          <AiOutlineTwitter className="text-[40px] hover:scale-125 hover:text-[#059669] ease-linear duration-300" />
        </a>
        <a target="_blank" href="mailto:adelekanadesiyan@gmail.com">
          <IoMdMail className="text-[40px] hover:scale-125 hover:text-[#059669] ease-linear duration-300" />
        </a>
      </div>
      <footer>
        <div className="absolute bottom-0 z-10 translate-x-[-50%] translate-y-[-50%] left-[50%] text-center">
          <p className="text-[10px]">
            Designed and built by Metalekan. <br />{" "}
            <span>{new Date().getFullYear()}</span>
          </p>
        </div>
      </footer>
      {/* <div className="absolute z-[0] w-[40%] h-[35%] translate-x-[-50%] translate-y-[-50%] top-0 pink__gradient" /> */}
      {/* <div className="absolute z-[1] w-[80%] h-[85%] bottom-40 round2ed-full white__gradient" /> */}
